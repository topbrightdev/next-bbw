          ...
          <div className="row no-gutters">
            <div className="col-lg-5 col-md-6">
              <div className="pt-10 pb-6 pl-11 pr-12 bg-black-2 h-100 d-flex flex-column dark-mode-texts">
                <div className="pb-9">
                  <h3 className="font-size-8  line-height-reset pb-4 line-height-1p4">Create a free account today</h3>
              ...
              <div className="bg-white-2 h-100 px-11 pt-11 pb-7">
                  ...
                  <div className="col-4 col-xs-12">
                    <Link href="#" passHref>
                      <a className="font-size-4 font-weight-semibold position-relative text-white bg-allports h-px-48 flex-all-center w-100 px-6 rounded-5 mb-4">
                        ...
                        <span className="d-none d-xs-block">Import from LinkedIn</span>
                      </a>
                    </Link>
                  </div>
                  <div className="col-4 col-xs-12">
                    <Link href="#" passHref>
                      <a className="font-size-4 font-weight-semibold position-relative text-white bg-poppy h-px-48 flex-all-center w-100 px-6 rounded-5 mb-4">
                        ...
                        <span className="d-none d-xs-block">Import from Google</span>
                      </a>
                    </Link>
                  </div>
                  <div className="col-4 col-xs-12">
                    <Link href="#" passHref>
                      <a className="font-size-4 font-weight-semibold position-relative text-white bg-marino h-px-48 flex-all-center w-100 px-6 rounded-5 mb-4">
                        <i className="fab fa-facebook-square pos-xs-abs-cl font-size-7 ml-xs-4"></i>{" "}
                        <span className="d-none d-xs-block">Import from Facebook</span>
                      </a>
                    </Link>
                  </div>
                </div>
                ...
                <form action="/">
                  ...
                  <p className="font-size-4 text-center heading-default-color">
                    ...
                    <Link href="#" passHref>
                      <a className="text-primary">Create a free account</a>
                    </Link>
                  </p>
                </form>
              </div>
