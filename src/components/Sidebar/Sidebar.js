  ...
  return (
    <>
      ...
      <div className="widgets mb-11">
        <h4 className="font-size-6 font-weight-semibold mb-6">Partner Type</h4>
        <ul className="list-unstyled filter-check-list">
          <li className="mb-2">
            <Check>Trading</Check>
          </li>
          <li className="mb-2">
            <Check>Connecting</Check>
          </li>
          {/* <li className="mb-2">
            <Check>Technology</Check>
          </li>
          <li className="mb-2">
            <Check>Academia</Check>
          </li>
          <li className="mb-2">
      ...
      <div className="widgets mb-11 ">
        <div className="d-flex align-items-center pr-15 pr-xs-0 pr-md-0 pr-xl-22">
          <h4 className="font-size-6 font-weight-semibold mb-6 w-75">Total Spend</h4>
          {/* <!-- Range Slider --> */}
