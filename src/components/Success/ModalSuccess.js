            ...
            <div className="col-lg-5 col-md-6">
              <div className="pt-10 pb-6 pl-11 pr-12 bg-dark-gray h-100 d-flex flex-column dark-mode-texts">
                <div className="pb-9">
                  ...
                  <p className="mb-0 font-size-4 text-white">Log in to continue to your account and explore new opportunities.</p>
                </div>
                <div className="border-top border-default-color-2 mt-auto">
                  <div className="d-flex mx-n10 pt-6 flex-xs-row flex-column">
                    <div className="pt-5 px-9">
                      <h3 className="font-size-7 text-white">17</h3>
                      <p className="font-size-3 text-white gr-opacity-5 line-height-1p4">Black owned businesses</p>
                    </div>
                    <div className="pt-5 px-9">
                      <h3 className="font-size-7 text-white">$120M</h3>
                      <p className="font-size-3 text-white gr-opacity-5 line-height-1p4">Total revenue</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white-2 h-100 px-11 pt-11 pb-7">
                ...
                <form action="/">
                  <div className="form-group">
                    ...
                    <input type="email" className="form-control" placeholder="example@company.com" id="email" />
                  </div>
                  <div className="form-group">
                  ...
                  <div className="form-group d-flex flex-wrap justify-content-between">
                    <label htmlFor="terms-check" className="gr-check-input d-flex  mr-3">
                      ...
                      <span className="font-size-3 mb-0 line-height-reset mb-1 d-block">Remember me</span>
                    </label>
                    <Link href="/#" className="font-size-3 text-dodger line-height-reset">
                      Forget Password
                    </Link>
                  </div>
