      ...
      <section className="py-13 py-lg-30">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-6 col-lg-5 col-md-10 col-sm-11" data-aos="fade-right" data-aos-duration="800">
              <div className="position-relative pr-lg-20 pr-md-15 pr-9">
                ...
                <div className="pos-abs-br mb-10 ">
                  <div className="card bg-white shadow-2 border-0">
                    <div className="card-header bg-dodger-2 text-white text-center border-0">Applicants List</div>
            ...
            <div className="col-lg-6 col-md-9 col-xs-10" data-aos="fade-left" data-aos-duration="800">
              {/* <!-- content-2 start --> */}
              <div className="content-2 pl-lg-10 pl-0 d-flex flex-column justify-content-center h-100 pt-lg-0 pt-11 pr-md-13 pr-xl-15 pr-xxl-25 pr-0">
                ...
                <p className="text-dodger font-size-4 font-weight-semibold mb-8">Looking for an expert for your company?</p>
                <h2 className="font-size-9 mb-8">Get applications from the world best talents.</h2>
                ...
                <Link href="/#">
                  <a className="btn btn-green btn-h-60 text-white w-180 rounded-5 text-uppercase">Post a Job</a>
                </Link>
              </div>
              {/* <!-- content-2 end --> */}
            </div>
