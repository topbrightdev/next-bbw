    ...
    <>
      ...
      <section className="bg-green position-relative">
        <div className="w-lg-50 ml-lg-auto">
          {/* <!-- gallery start --> */}
          <div className="gallery" data-aos="fade-left" data-aos-duration="800" data-aos-delay="300">
        ...
        <div className="container pos-lg-abs-c pt-11 pb-13 py-lg-0">
          <div className="row">
            <div className="col-xxl-5 col-lg-6 col-md-8 mx-auto mx-lg-0" data-aos="fade-right" data-aos-duration="800">
              {/* <!-- content-2 start --> */}
              <div className="content-2 pr-lg-5 pr-xl-18 pr-xxl-10 text-center text-lg-left">
                {/* <!-- content-2 section title start --> */}
                <p className="text-white font-size-4 font-weight-semibold mb-8">Looking for an expert for your company?</p>
                <h2 className="font-size-9 text-white mb-8">Get applications from the world best talents.</h2>
                ...
                {/* <!-- content-2 btn start --> */}
                <Link href="/#">
                  <a className="btn btn-white btn-h-60 text-black-2 w-180 rounded-5 text-uppercase mx-auto mx-lg-0">Post a Job</a>
                </Link>
                {/* <!-- content-2 btn end --> */}
              </div>
            </div>
