                  ...
                  <div className="row no-gutters align-items-center justify-content-center">
                    <div className="col-12 col-xl-5 col-lg-5">
                      ...
                      <div className="slide-img">
                        <img className="rounded-left w-100" src={imgT1} alt="" />
                      </div>
                    </div>
                      ...
                      <div className="slide-content pl-5 pl-lg-10 pl-xxl-20 pr-5 pr-xl-5 py-lg-5 py-9">
                        ...
                        <div className="">
                          <p className="font-size-6 text-black-2 pr-5 mb-10">
                            “Being a small but growing brand, we have to definitely do a lot more with less. And when you want to create
                            a business bigger than yourself, you’re going to need help. And that’s what Justcamp does.”
                          </p>
                          {/* <!-- User Info --> */}
                          <div className="">
                            <h4 className="font-size-6 text-black-2 mb-0">Brandon & Rivera</h4>
                            <span className="font-size-4 text-gray">Co-founders of Greener</span>
                          </div>
                        </div>
                        {/* <!-- Slide Info End --> */}
                      </div>
